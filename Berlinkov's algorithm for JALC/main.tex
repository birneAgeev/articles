...
\runningtitle{Testing synchronization in linear expected time}

\runningauthors{\textsc{P.~Ageev}}
...
%and seems to tend to a constant
...
\section*{Acknowledgement} The author is grateful to his scientific advisor Professor Mikhail Volkov for helping with this article, to Mikhail Berlinkov for the explanation of his algorithm, and to Mikhail Samoilenko for useful discussions.
